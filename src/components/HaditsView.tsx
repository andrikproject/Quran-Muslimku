  ...
  return (
    <div className="flex flex-col h-full bg-[#FDFBF7] relative max-w-2xl mx-auto w-full pb-20">
      <div className="sticky top-0 bg-[#FDFBF7]/90 backdrop-blur-xl border-b border-slate-200/60 z-20 px-5 py-4 flex items-center gap-4">
        ...
        <div>
          <h3 className="font-bold text-[#0F4C3A] text-lg leading-tight">Kumpulan Hadits</h3>
          ...
          {!selectedBook ? (
            ...
            >
              <div className="flex flex-col items-center py-8 text-center bg-white rounded-3xl border border-emerald-100/50 shadow-sm mb-2 relative overflow-hidden">
                ...
                <h3 className="font-serif font-bold text-[#0F4C3A] text-xl relative z-10">Kutubus Sittah</h3>
                <p className="text-xs text-emerald-800/70 font-medium mt-1.5 relative z-10">Perpustakaan kitab hadits Shahih & Sunan.</p>
              </div>
                  ...
                  {books.map(book => (
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <h4 className="font-bold text-slate-800 text-sm group-hover:text-[#0F4C3A] transition-colors">{book.name}</h4>
            ...
            >
              {isLoadingHadiths ? (
                <div className="flex flex-col items-center justify-center py-32 text-[#0F4C3A]">
                  ...
                  <span className="text-[10px] font-bold mt-5 uppercase tracking-widest opacity-80 text-emerald-800 bg-emerald-50 px-4 py-1.5 rounded-full border border-emerald-100">Menyusun Hadits...</span>
                </div>
              ) : hadiths.length > 0 ? (
                <div className="flex flex-col gap-4">
                  {hadiths.map((h, i) => (
                    <div key={h.number} className="bg-white border border-slate-200/60 rounded-[28px] p-6 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group">
                       ...
                       <p className="font-arabic text-[26px] sm:text-[30px] leading-[2.5] text-right text-slate-800 mb-8 mt-2" dir="rtl">
                         {h.arab}
                       </p>
